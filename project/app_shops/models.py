...
class BaseShop(models.Model):
    ...
    logo = models.ImageField(upload_to='shops/', default='images/default-logo.jpg', blank=True, null=True)
...
class ShopCreationRequest(BaseShop):
    ...
    logo = models.ImageField(upload_to='bids/', default='images/default-logo.jpg', blank=True, null=True)
